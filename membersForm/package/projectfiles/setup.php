...
<head>
  ...
  <meta name="description" content="Setup Page 1">
...
<body>
  <section class="menu cid-qKXibcqTjl" once="menu" id="menu1-2s">
...
<section class="engine"><a href="https://mobirise.ws/m">drag and drop site maker</a></section><div id="custom-html-2u" custom-code="true" data-rv-view="194"><section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background" style="background-image: url(assets/images/060510a0025-2000x1334-77.jpg);">
    <script type="text/javascript" src="utils/lchkbn1908enc.js"></script>
    <div class="mbr-overlay" style="opacity: 0.2; background-color: rgb(0, 0, 0);"></div>
    <div class="mbr-table-cell">
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    <h1 class="mbr-section-title display-1">SYSTEM SET UP STEP 1</h1>
                    <h2 class="mbr-section-title2 display-1">Registration Code</h2>
                    <p class="mbr-section-lead">This section allows you to set up your system parameters and database tables etc.<br>Please follow the prompts carefully to ensure a successful installation.</p>
                            <div class="col-md-8 col-md-offset-2 text-xs-center">
                                <div class="form-group">
                                    <label for="regcode">Enter your Registration and Set Up Code *</label>
									<input maxlength="50" type="text" placeholder="Registration/Set Up Code *" id="regcode" name="regcode" value="" class="rs-form-control" style="width:350px;">
                    </div>
                    <div class="btn btn-lg btn-primary" onclick="checkLicense();">CONTINUE</div>
            </div>
        </div>
    </div>
                </div>
...
<section class="cid-qKXv2sPeDK" id="footer1-2t">
