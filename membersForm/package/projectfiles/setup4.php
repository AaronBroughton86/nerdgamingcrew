...
<head>
  ...
  <meta name="description" content="Setup Page 4">
...
<body>
  <section class="menu cid-qKXibcqTjl" once="menu" id="menu1-36">
...
<section class="engine"><a href="https://mobirise.ws/g">create free website</a></section><div id="custom-html-38" custom-code="true" data-rv-view="217"><?php
...
<div id="custom-html-39" custom-code="true" data-rv-view="218"><section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background" style="background-image: url(assets/images/060510a0025-2000x1334-77.jpg);">
    <div class="mbr-overlay" style="opacity: 0.2; background-color: rgb(0, 0, 0);"></div>
    <div class="mbr-table-cell">
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    <h1 class="mbr-section-title display-1">SYSTEM SET UP STEP 4</h1>
                    <h2 class="mbr-section-title2 display-1">Create Database Tables</h2>
                    <p class="mbr-section-lead lead">This page will create the Database Tables for the membership system automatically, please check that no errors are reported and then click Continue to go to Step 5.</p>
<?php
include "utils/createdbtables.php";
echo '<div class="mbr-section-btn"><a class="btn btn-lg btn-primary" href="setup5.php?lic='.$_REQUEST["lic"].'&token='.$_REQUEST["token"].'&go='.$_REQUEST["go"].'">CONTINUE</a> </div>';
?>                    
...
<div id="custom-html-3f" custom-code="true" data-rv-view="219"><div class="RSinvisible">DO NOT REMOVE THIS BLOCK! REQUIRED FOR PAGE SECURITY</div>
<?php
}
?></div>

<section class="cid-qKXzPwcPrF" id="footer1-37">
