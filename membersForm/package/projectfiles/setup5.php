...
<head>
  ...
  <meta name="description" content="Setup Page 5">
...
<body>
  <section class="menu cid-qKXibcqTjl" once="menu" id="menu1-3a">
...
<section class="engine"><a href="https://mobirise.ws/c">best web site maker</a></section><div id="custom-html-3c" custom-code="true" data-rv-view="225"><?php
...
<div id="custom-html-3d" custom-code="true" data-rv-view="226"><section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background" style="background-image: url(assets/images/060510a0025-2000x1334-77.jpg);">
    <div class="mbr-overlay" style="opacity: 0.2; background-color: rgb(0, 0, 0);"></div>
    <div class="mbr-table-cell">
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    <h1 class="mbr-section-title display-1">SYSTEM SET UP STEP 5</h1>
                    <h2 class="mbr-section-title2 display-1">Set Up is Complete</h2>
                    <p class="mbr-section-lead lead">Set up has now been completed (providing you received no error message) you can now test your system and set the final parameters on the admin page. Click the button below to log in and then select admin from the Log In top menu.</p>
<div class="mbr-section-btn"><a class="btn btn-lg btn-primary" href="login.php">CLICK TO LOG IN</a> </div>
                </div>
            </div>
        </div>
    </div>
...
<div id="custom-html-3e" custom-code="true" data-rv-view="227"><div class="RSinvisible">DO NOT REMOVE THIS BLOCK! REQUIRED FOR PAGE SECURITY</div>
<?php
}
?></div>

<section class="cid-qKXAKc3Fxr" id="footer1-3b">
