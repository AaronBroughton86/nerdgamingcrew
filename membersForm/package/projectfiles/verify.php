...
<script src="js/RSverifyemail.js"></script>
</head>
<body>
  <section class="menu cid-qKW30RsPde" once="menu" id="menu1-1a">
...
<section class="engine"><a href="https://mobirise.ws/p">open source website creator</a></section><div id="custom-html-1c" custom-code="true" data-rv-view="101"><section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background mbr-section-with-arrow" style="background-image: url(assets/images/050410x0216-2000x1334-96.jpg);">
    <div class="mbr-overlay" style="opacity: 0.5; background-color: rgb(0, 0, 0);"></div>
    <div class="mbr-table-cell">
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    <h1 class="mbr-section-title display-1">VERIFY YOUR EMAIL</h1>
                    <p class="mbr-section-lead lead">Please verify your email address to activate your account.<br>Enter the code sent to your email address below:<br><br></p>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="vcode">Verification Code *</label>
									<input maxlength="100" type="text" placeholder="Your Verification Code *" id="vcode" name="vcode" value="<?php echo $_GET["SID"]?>" class="rs-form-control">
                                </div>
							</div>
							<div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">Email Address *</label>
									<input maxlength="150" type="text" class="rs-form-control" placeholder="Email address *" id="email" name="email" value="<?php echo $_GET["EID"]?>">
                                </div>
							</div>
							<div class="col-md-12">
                                <div class="form-group">
                <div id="verify-butt" class="btn btn-md btn-primary" onclick="verifyEmail();">VERIFY</div>
                                </div>
							</div>
				</div>
			</div>
...
<section class="cid-qKWXs9I0Qy" id="footer1-1b">
