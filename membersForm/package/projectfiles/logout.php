...
<body>
  <section class="menu cid-qKW30RsPde" once="menu" id="menu1-y">
...
<section class="engine"><a href="https://mobirise.ws/g">create free website</a></section><section class="header3 cid-qKWJPVc2Sp mbr-fullscreen mbr-parallax-background" id="header3-10">
        ...
        <div class="media-container-row">
            ...
            <div class="media-content">
                <h1 class="mbr-section-title mbr-white pb-3 mbr-fonts-style display-2"><strong>
                    You have been logged out successfully</strong></h1>
                
                <div class="mbr-section-text mbr-white pb-3 ">
                    
                </div>
                <div class="mbr-section-btn"><a class="btn btn-md btn-primary display-4" href="login.php">LOG IN AGAIN</a>
                    <a class="btn btn-md btn-white-outline display-4" href="index.html">HOME PAGE</a></div>
            </div>
        </div>
    </div>
...
<section class="cid-qKWJIyOwJF" id="footer1-z">
