...
<head>
  ...
  <meta name="description" content="Members Offers Page">
  <title>Members Offers Page</title>
...
<body>
  <section class="menu cid-qKX90QvEij" once="menu" id="menu1-1z">
...
<section class="engine"><a href="https://mobirise.ws/i">build your own website</a></section><div id="custom-html-20" custom-code="true" data-rv-view="144"><?php if(!isset($_SESSION["loggedin"]) ||(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"]!="active")){ ?>
...
<section class="mbr-section content4 cid-qKX90VUpme" id="content4-23">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><strong>MEMBERS OFFERS</strong></h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">Here are your exclusive offers.
<div>This is a demonstration page.</div></h3>
...
<section class="cid-qKXhPeswzF" id="pricing-tables1-29">
...
<div id="custom-html-25" custom-code="true" data-rv-view="150"><div class="RSinvisible">DO NOT REMOVE THIS BLOCK! REQUIRED FOR PAGE SECURITY</div>
<?php } ?></div>

<section class="cid-qKX9103MKO" id="footer1-26">
