...
<head>
  ...
  <meta name="description" content="Members Photos Page">
  <title>Members Photos Page</title>
...
<body>
  <section class="menu cid-qKXibcqTjl" once="menu" id="menu1-2a">
...
<section class="engine"><a href="https://mobirise.ws/h">make your own website</a></section><div id="custom-html-2b" custom-code="true" data-rv-view="156"><?php if(!isset($_SESSION["loggedin"]) ||(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"]!="active")){ ?>
...
<section class="features16 cid-qKXiHfQVvB" id="features16-2g">
    
    
    
    <div class="container align-center">
        <h2 class="pb-3 mbr-fonts-style mbr-section-title display-2"><strong>
            MEMBERS PHOTOS</strong></h2>
        <h3 class="pb-5 mbr-section-subtitle mbr-fonts-style mbr-light display-5">A collection of photos taken by our members</h3>
        <div class="row media-row">
            
        <div class="team-item col-lg-3 col-md-6">
                <div class="item-image">
                    <img src="assets/images/33274763-2000x1330-67-2000x1330.jpg" alt="Photo 1" title="Photo 1">
                </div>
                ...
                <div class="item-image">
                    <img src="assets/images/060607w0008-2000x1334-66-2000x1334-38-800x534.jpg" alt="Photo 2" title="Photo 2">
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p class="mbr-fonts-style display-5">
                ...
                <div class="item-image">
                    <img src="assets/images/19260640-2000x1330-48-2000x1330.jpg" alt="Photo 3" title="Photo 3">
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p class="mbr-fonts-style display-5">
                ...
                <div class="item-image">
                    <img src="assets/images/30332160-2000x1331-93-2000x1331.jpg" alt="Photo 4" title="Photo 4">
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p class="mbr-fonts-style display-5">
...
<div id="custom-html-2e" custom-code="true" data-rv-view="169"><div class="RSinvisible">DO NOT REMOVE THIS BLOCK! REQUIRED FOR PAGE SECURITY</div>
<?php } ?></div>

<section class="cid-qKXibjQu5A" id="footer1-2f">
