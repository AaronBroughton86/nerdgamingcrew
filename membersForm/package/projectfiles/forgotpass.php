...
<script src="js/RSresetpass.js"></script>
<link rel="stylesheet" href="css/RSinvisible.css" type="text/css">
</head>
<body>
  <section class="menu cid-qKW30RsPde" once="menu" id="menu1-v">
...
<section class="engine"><a href="https://mobirise.ws/p">open source website builder</a></section><div id="custom-html-x" custom-code="true" data-rv-view="71"><section class="mbr-section mbr-parallax-background" style="background-image: url(assets/images/desert.jpg); padding-top: 160px; padding-bottom: 120px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h3 class="mbr-section-title display-2">FORGOT PASSWORD<br></h3>
                <p>If you have forgotten your password fill in the details below and click the Reset button. <br>An email will be sent to your registered email address with reset instructions.</p> 
                <div>
                               ...
                               <div class="form-group">
								...
								<div class="btn btn-md btn-primary" onclick="resetPass();">RESET PASSWORD</div>
			</div>
            </div>
        </div>
    </div>
...
<section class="cid-qKWEwBnCkM" id="footer1-w">
