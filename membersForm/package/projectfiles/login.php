...
<script src="js/RSchecklogin.js"></script>
<link rel="stylesheet" href="css/RSinvisible.css" type="text/css">
</head>
<body>
  <section class="menu cid-qKW30RsPde" once="menu" id="menu1-r">
...
<section class="engine"><a href="https://mobirise.ws/p">open source website creator</a></section><section class="header3 cid-qKWAicQUtD mbr-fullscreen mbr-parallax-background" id="header3-u">
        ...
        <div class="media-container-row">
            ...
            <div class="media-content">
                <h1 class="mbr-section-title mbr-white pb-3 mbr-fonts-style display-2"><strong>
                    MEMBERS LOG IN</strong></h1>
                <h3 class="mbr-section-subtitle align-left mbr-white mbr-light pb-3 mbr-fonts-style display-7">If you do not have an account please register <a href="http://register.php">here</a>.</h3>
                                <div class="mbr-section-text mbr-white pb-3 ">
 <form name="frmLogin" id="frmLogin" action="login.php" method="post" target="_self">
                          <div class="form-group">
                                    <label for="userid">User ID *</label>
									<input maxlength="30" type="text" class="rs-form-control" placeholder="User ID *" id="userid" name="userid" value="">
                                </div>
                               <div class="form-group">
                                    <label for="password">Password *</label>
									<input maxlength="30" type="password" class="rs-form-control" placeholder="Password *" id="password" name="password" value="">
                                </div>
                            <div class="clearfix"></div>
                  </form></div>              
                <div class="mbr-section-btn"><a class="btn btn-md btn-primary display-4" onclick="checkLogin();">LOG IN</a>
                    <a class="btn btn-md btn-white-outline display-4" href="forgotpass.php">Forgot Password</a></div>
            </div> 
        </div>
    </div>
...
<section class="cid-qKWyrNij8S" id="footer1-s">
