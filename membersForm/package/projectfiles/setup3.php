...
<head>
  ...
  <meta name="description" content="Setup Page 3">
...
<body>
  <section class="menu cid-qKXibcqTjl" once="menu" id="menu1-31">
...
<section class="engine"><a href="https://mobirise.ws/l">free html site maker</a></section><div id="custom-html-33" custom-code="true" data-rv-view="209"><?php
...
<div id="custom-html-34" custom-code="true" data-rv-view="210"><section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background" style="background-image: url(assets/images/060510a0025-2000x1334-77.jpg);">
    <div class="mbr-overlay" style="opacity: 0.2; background-color: rgb(0, 0, 0);"></div>
    <div class="mbr-table-cell">
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    <h1 class="mbr-section-title display-1">SYSTEM SET UP STEP 3</h1>
                    <h2 class="mbr-section-title2 display-1">Write System Parameters File</h2>
                    <p class="mbr-section-lead lead">This page will create the system parameters file used throughout the membership area automatically, please check that no errors are reported and then click Continue to go to Step 4 which will create the database tables.</p>
<?php
include "utils/writeconnectionfile.php";
$url2use='setup4.php?lic='.$_POST["lic"].'&token='.$_POST["token"].'&go='.$_POST["go"].'&f=1'; 
echo '<div class="mbr-section-btn"><a class="btn btn-lg btn-primary" href="'.$url2use.'">CONTINUE</a> </div>';              
?>                    
...
<div id="custom-html-35" custom-code="true" data-rv-view="211"><div class="RSinvisible">DO NOT REMOVE THIS BLOCK! REQUIRED FOR PAGE SECURITY</div>
<?php
}
?></div>

<section class="cid-qKXyLUTI4W" id="footer1-32">
